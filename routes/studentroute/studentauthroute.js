...
const udpateAvatarMiddleware = require("../../middleware/upateAvatarMiddleware");
...
router.post("/update-student-avatar/:studentid", async (req, res) => {

 const updateAvatar=udpateAvatarMiddleware.single('avatar');
